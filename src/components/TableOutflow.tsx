...
const TableOutflow = () => {
    ...
    const transactions = async(page: number) => {
        setPage(page);
        setLoading(true);
        getTransactions({link: 'e9b7f135-52eb-4b6d-8de1-91ffd2dd9a65', type: 'OUTFLOW', page: page}).then((transactions) => {
    ...
    return (
        <Card >
            <h3 className="text-xl mb-2 text-red-500 font-bold">
                Expenses <span className='mdi mdi-arrow-down'></span>
            </h3>
